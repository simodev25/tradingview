...
strategy.exit(id="long_exit", from_entry="Long", limit=t_target, stop=t_stop, when=strategy.position_size > 0 ,comment ="ID:"+ tostring(longId))
strategy.exit(id="short_exit", from_entry="Short", limit=t_target, stop=t_stop, when=strategy.position_size < 0,comment ="ID:"+ tostring(shortid))
