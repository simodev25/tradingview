...
//@version=5
strategy("Hammers & Stars Strategy [v2.3]", shorttitle="HSS[v2.3]", overlay=true, commission_type=strategy.commission.percent, commission_value=0)

// Fonction pour générer un ID unique
generateUniqueId() =>
    var int x = 1
    x := (16708 * nz(x[1], 1) + int(time)) % 2147483647
    str.tostring(x)
...
rr = input.float(title="R:R", defval=0.5, group=g_strategy, tooltip="Profil Risque:Récompense")
